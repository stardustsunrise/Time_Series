...
#scatterplot showing movement in over from 2002 to 2025


plot(Price_data$Date, Price_data$avg_price_canada, main="Scatterplot of wheat prices",
...
plot(Price_data$Months, Price_data$avg_price_canada, main="Scatterplot of price of wheat over monthly",
...
#visibly there are some outliers in year 2011 and 2020, but due to their proximity to minimum and maximum we will include them in our data set
